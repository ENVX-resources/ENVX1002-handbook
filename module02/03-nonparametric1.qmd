...
GenStat requires the data to be set up as a 4x3 Table type of spreadsheet (as opposed to a Variate or Matrix). It then reports the $\chi^2$ test statistic and P-Value by selecting the Pearson method.
