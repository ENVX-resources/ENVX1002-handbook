...
![Screenshot: Format Trendline](img/format_trendline.png)
...
![Figure 1: Plot of Yield-response to fertiliser](img/Practical_Topic9_yieldfert.jpg)
...
![Screenshot of Predicted column input](img/pred_eqtn.png)
...
![Screenshot of solver with input values](img/solver.png)
...
e) Intercept = 4.7619 = $b_0$
   fert = 5.4286 = $b_1$
   These coefficients should be the same as those calculated in Excel. 
...
ABARES <- read_excel("ENVX1002_practical_data_Regression.xlsx", sheet = "ABARES")
