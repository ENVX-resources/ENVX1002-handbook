---
title: "ENVX1002 Practical Topic 10 - Linear Functions"
output:
  pdf_document:
      fig_width: 7
      fig_height: 6
...
```{r LoadPeanutData}
library(readxl)
Peanuts <- read_xlsx("ENVX1002_wk10_practical_data_Regression.xlsx", "Peanuts")
head(Peanuts)
```
<br>
...
Dippers <- read_xlsx("ENVX1002_wk10_practical_data_Regression.xlsx"
                     ,"Dippers")
```
...
Back to the original question: Does the number of caddis fly larvae influence the number of breeding pairs of Dippers?
Yes, but based on our findings, this relationship is not very strong. 
