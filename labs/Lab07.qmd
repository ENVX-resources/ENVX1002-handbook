...
2.  the differences can be meaningfully ordered and are approximately symmetric about the median. Note that these tests are reasonably robust to some outliers.
