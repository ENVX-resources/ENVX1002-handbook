...
2.  Mann-Whitney U test - used to compare two independent samples to assess whether their population distributions differ (similar to a two sample t-test.
...
## Quick introduction to chi-squared tests
...
## Exercise 2: wild tulips (walk-through)
