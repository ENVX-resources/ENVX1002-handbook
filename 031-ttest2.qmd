...
What do you do if when you’re checking your assumptions for a two- sample t-test you find…
	Normality   
...
The null and alternate hypotheses remain the same,
i.e.	H0: μ1 = μ2		or      H0: μ1 - μ2 = 0
